...
- **Problem_3:** Print a block `F` using hash (#) with height 6 and width 5/4 characters. 
  
- **Problem_4:** Input two numbers and perform all arithmetic operations (sum, difference, product, quotient, modulus). 
